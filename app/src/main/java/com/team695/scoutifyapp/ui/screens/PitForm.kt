...
//be able to clear a radio button or check box
// scrollbar visible?,
// pictures
//submit -> do submit backend
//image upload - be able to take a picture, not just select an already existing picture
        ...
        Column(
            ...
            OTF(
                ...
                required=requiredList.push(
                        remember { Required(valid = { teamName!=="" }) }
                )
            )
            ...
            RB(
                ...
                required=requiredList.push(
                    remember { Required(valid = { _drive!=="" }) }
                )
            )
            ...
            RB(
                ...
                required=requiredList.push(
                    remember { Required(valid = { _wheels!=="" }) }
                )
            )
            ...
            RB(
                ...
                required=requiredList.push(
                    remember { Required(valid = { _coralAcquisition!=="" }) }
                )
            )
            ...
            RB(
                ...
                required=requiredList.push(
                    remember { Required(valid = { _algaeAcquisition!=="" }) }
                )
            )
            ...
            RB(
                ...
                label = "Algae Scoring:",
                required=requiredList.push(
                    remember { Required(valid = { _algaeScoring!=="" }) }
                )
            )
            ...
            OTF(
                ...
                required=requiredList.push(
                    remember { Required(valid = { weight !== "" && weight.matches(numberPattern) }) }
                )
            )
            ...
            OTF(
                ...
                keyboardType = KeyboardType.Number,
                required=requiredList.push(
                    remember {  Required(valid={length!==""&&length.matches(numberPattern)}) }
                )
            )
            ...
            OTF(
                ...
                keyboardType = KeyboardType.Number,
                required=requiredList.push(
                    remember { Required(valid = { width !== "" && width.matches(numberPattern) }) }
                )
            )
            Text("Robot Height")
            ...
            OTF(
                ...
                keyboardType = KeyboardType.Number,
                required=requiredList.push(
                    remember { Required(valid = { height !== "" && height.matches(numberPattern) }) }
                )
            )
            ...
            OTF(
                ...
                keyboardType = KeyboardType.Number,
                required=requiredList.push(
                    remember { Required(valid = { heightMax !== "" && heightMax.matches(numberPattern) }) }
                )
            )
            ...
            RB(
                ...
                required=requiredList.push(
                    remember { Required(valid = { _driveTeam !== "" }) }
                )
            )
